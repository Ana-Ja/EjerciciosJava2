...
//		add(botonVerde);
	...
	//y poner el objeto oyente a la escucha
		...
		//JButton (Action a) que pone el botón a la escucha de la acción de turno
		// La clase que determina la acción con su método actionPerformed está creada justo debajo 
		//de la instanciación.
		add( new JButton(accionAmarillo));
		add( new JButton(accionAzul));
		add( new JButton(accionRojo));
		
		//***** 2º fuente de evento: la combinacon de teckas******//
