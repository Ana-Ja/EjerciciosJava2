package graficos;
 ...
 //codigo copiado de Internet https://docs.oracle.com/javase/tutorial/uiswing/misc/action.html
...
public class Demo_Barra_Herramientas extends JPanel
    ...
    public Demo_Barra_Herramientas() {
    ...
    protected static ImageIcon createNavigationIcon(String imageName) {
        String imgLocation = "toolbarButtonGraphics/navigation/"
                             + imageName
                             + ".gif";
        java.net.URL imageURL = Demo_Barra_Herramientas.class.getResource(imgLocation);
    ...
    private static void createAndShowGUI() {
        ...
        Demo_Barra_Herramientas demo = new Demo_Barra_Herramientas();
